...
_README_TEXT = (
    ...
    "     起きません。\n"
    "  ★ 開いたまま PC をシャットダウンすると、直前 10 分間の作業が\n"
    "     消えることがあります。作業が終わったら Excel を閉じ、bat と\n"
    "     一緒に開いた黒い画面(コマンドプロンプト)が自動で消えるまで\n"
    "     待ってから PC をシャットダウンしてください(この画面は\n"
    "     OneDrive への書き戻しが終わると自動で消えます。手動で\n"
    "     閉じたり ×で消したりしないでください)。\n"
