...
- **実質凍結（残100字未満・2026-08-20 R34 実測）**: **`modBoard`19** / `modSkin`27 / `modUINexusDraw`37 / `modChunker`61 / **`modHubStat`77** / `modUIShelf`85。**1行も入らない**。（`modApp` は R34 B0 の分割手術で残488へ回復し離脱）
- **逼迫（残300字未満＝分割裁定必須）**: `modViewport`118 / `modGateway`125 / `modUIMain`150 / `modUI`167 / **`modShare`186**（実体はmodChatLog等へ・自分は1行呼び出しの型を維持） / **`modBackdrop`197** / `modClarify`233 / `modVaultGallery`286。
- **準逼迫（残1,000字未満・次に触るときは要注意）**: `modChrome`350 / `modExtractor`377 / `modChannel`389 / `modShelfStore`431 / **`modHub`449** / `modApp`488 / **`modUtilText`584** / `modViewport2`688 / `modKnowledge`708 / **`modAsk`732（凍結。R34 F1手術後。次に手術するなら分割が先）** / `modSparse`953 / **`modShareRule`1,238** / `modAskRetrieve`1,092 / `modUtil`2,008 / `modPrompts`2,321（凍結） / `modInsightIo`2,606。テスト側は `modTestsPure24`347 / `modTestsPure25`365 / `modTestsPure18`402 / `modTestsPure2`451 / `modTestsPure34`705。
- **受け皿（実測残り）**: `modTypes`28,831 / `modAppDef`27,268 / `modState`26,645 / `modClip`25,603 / `modFeatures`24,307 / **`modChatLog`23,490**（R34からboard系.bak掃除の実体も同居） / `modGatewayDirect`22,314 / `modConfig`21,980 / `modInstallCheck`20,946 / `modProgressBar`17,542 / `modInsightGate`14,668 / `modExtractorExcel`14,347 / `modAppState`13,810→12,943 / `modStarter`13,389 / **`modTelemetry`11,896** / `modPublishUI`10,536 / `modMode`9,613 / `modGuard`9,342 / `modGenPipe`8,014 / `modDiag`8,097 / `modDash`5,879 / `modShared`3,448。
