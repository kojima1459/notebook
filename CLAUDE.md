...
- **準逼迫（残1,000字未満・次に触るときは要注意・2026-09-05 R37 実測）**: **`modApp`332**（R36 で `SaveTurnKind`/`CleanupSheet` の1行呼び出し。実体は modAppState/modTextView へ） / `modChrome`350 / `modExtractor`377 / `modChannel`389 / **`modKnowledge`416** / `modShelfStore`431 / **`modHub`449** / **`modUtilText`584** / `modIntegrity`666 / `modViewport2`688 / **`modAsk`732（凍結。次に手術するなら分割が先）** / `modSparse`953 / **`optOcrCore`1,331（R40 F1 で BuildRunCommand を -sstdout 挿入に・ヘッダ整理。2026-09-08 実測。次に触るなら読み取り側を新モジュールへ）** / **`modTestsPure6`1,212（R40 でゴールデン更新）** / **`modShelf`2,001（凍結）** / **`modShareRule`1,238** / `modShelfBatch`1,698 / `modUtil`2,008 / `modPrompts`2,321（凍結） / `modInsightIo`2,365。テスト側は `modTestsPure24`347 / `modTestsPure25`365 / `modTestsPure18`402 / `modTestsPure2`451 / `modTestsPure34`705 / `modTestsPure35`723 / `modTestsPure11`738 / `modTestsPure33`997。
