...
- **実質凍結（残100字未満・2026-08-20 R34 実測）**: **`modBoard`19** / `modSkin`27 / `modUINexusDraw`37 / `modChunker`61 / **`modHubStat`77** / `modUIShelf`96（2026-09-03 R35 F2a 実測）。**1行も入らない**。（`modApp` は R34 B0 の分割手術で残488へ回復し離脱）
