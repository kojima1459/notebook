...
- **実質凍結（残100字未満・2026-08-20 R34 実測）**: **`modBoard`19** / `modSkin`27 / `modUINexusDraw`37 / `modChunker`61 / **`modHubStat`77** / `modUIShelf`96（2026-09-03 R35 F2a 実測）。**1行も入らない**。（`modApp` は R34 B0 の分割手術で残498へ回復し離脱。2026-09-03 R35 M1 python len再実測）
...
- **準逼迫（残1,000字未満・次に触るときは要注意）**: `modChrome`350 / `modExtractor`377 / `modChannel`389 / `modShelfStore`431 / **`modHub`449** / `modApp`498 / **`modUtilText`584** / `modViewport2`688 / `modKnowledge`708 / **`modAsk`732（凍結。R34 F1手術後。次に手術するなら分割が先）** / `modSparse`953 / **`modShareRule`1,238** / `modAskRetrieve`1,092 / `modUtil`2,008 / `modPrompts`2,321（凍結） / `modInsightIo`2,606。テスト側は `modTestsPure24`347 / `modTestsPure25`365 / `modTestsPure18`402 / `modTestsPure2`451 / `modTestsPure34`705。
